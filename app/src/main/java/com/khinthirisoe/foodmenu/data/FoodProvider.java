...
public class FoodProvider extends ContentProvider {
    ...
    static {
        sUriMatcher.addURI(FoodContract.CONTENT_AUTHORITY, FoodContract.PATH_FOODS, PETS);
        sUriMatcher.addURI(FoodContract.CONTENT_AUTHORITY, FoodContract.PATH_FOODS + "/#", PET_ID);
    }
